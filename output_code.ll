...
entry:
  ...
  store float 0x40179999A0000000, float* %forDebug, align 4
  store float 4.200000e+01, float* @x, align 4
  store float 9.000000e+00, float* %forDebug, align 4
  store float 8.400000e+01, float* @y, align 4
  store float -9.000000e+00, float* @u, align 4
  call void @test_procedure()
  store float 0.000000e+00, float* @ret, align 4
  %0 = load float, float* @ret, align 4
  ret float %0
}
...
entry:
  %forDebug = alloca float, align 4
  store float 4.200000e+01, float* @hola, align 4
  store float 0x40179999A0000000, float* %forDebug, align 4
  ret void
}
